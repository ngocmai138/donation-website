              ...
              <th>
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3>${u.user.fullName}</h3>
                    <div class="meta" style="color: #373b3e !important;">${u.created }</div>
                    <p>${u.money } VND
                    <br>
                    ${u.status == 0 ? "Chờ xác nhận": u.status == 1 ? "Đã xác nhận" : "Đã hủy xác nhận"}
                    </p>
                  </div>
                </li>
              </th>
        ...
        <div class="col-lg-6">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              ...
              <li class="mb-2"><strong class="text-black">Tổng tiền quyên góp nhận được: </strong>${donation.money } VND</li>
              <li class="mb-2"><strong class="text-black">Trạng thái:</strong>
                <span >${status.getStatusString(donation.status) }</span>
              </li>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <f:form modelAttribute="donate" action="${pageContext.request.contextPath }/addDonate" method="get">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control"
                         id="addname" name="name" value="${user.fullName }" readonly>
                  <label for="addname"
                         class="col-form-label">Số tiền quyên góp:</label>
                  <input type="number" class="form-control" placeholder=""
                         id="addname" name="money" required>
                  <input type="hidden" class="form-control" placeholder=""
                         id="addname" name="userId" value="${user.id }" >
                  <input type="hidden" class="form-control" placeholder=""
                         id="addname" name="donationId" value="${ donation.id}" required>
