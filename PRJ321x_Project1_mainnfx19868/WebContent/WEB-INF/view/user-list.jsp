        ...
        <div class="card mb-4">
          <div class="card-header">
            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                    data-bs-target="#exampleModalAdd">Thêm mới</button>
            <!-- Modal Add-->
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <f:form modelAttribute="user" action="${pageContext.request.contextPath }/admin/addUser">
                      <div class="row">
                        <div class="col-6">
                          <label for="addname"
...
<!--                  <td th:text="${user.address}"></td>-->
                  ...
                  <td style=" ${u.status == 1? 'color: #1c7430':'color: red'}; font-weight: bold">${u.status == 1 ? 'Hoạt động' : 'Đã Khóa'}</td>
                  
                  <td style="width : 270px">
                    <button type="button" style="width: 80px" class="btn btn-success" data-bs-toggle="modal"
                            data-bs-target="#idModelMail${u.id}">
                      Gửi
                    </button>
                    ...
                    <button type="button" style="width: 80px" class="btn btn-danger mt-1" data-bs-toggle="modal"
                            data-bs-target="#idModelDel${u.id}" >
                      Xóa
                    </button>
                    <f:form action="${pageContext.request.contextPath}/admin/changeStatusUser" style="margin-left: 85px;margin-top: -38px">
                      <input type="hidden" class="form-control" id="id" name="userId" value="${u.id}">
                      <button type="submit" style="width: 80px" class="btn ${u.status == 0 ? 'btn-success':'btn-danger'}" >
                        ${u.status == 1 ? 'Khóa':'Mở'}
                      </button>
                    </f:form>
                    ...
                    <div class="modal fade" id="idModelMail${u.id}" tabindex="-1"
                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Gửi đến: <span>${u.email}</span></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                          </div>
                          <div class="modal-body">
                            <f:form action="@{/ql-user/send-mail}" method="post">
                              <input type="hidden" class="form-control" id="id" name="userId" value="${u.id}">
                              <label for="addname"
                    ...
                    <div class="modal fade" id="idModelDetail${u.id}" tabindex="-1"
                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Chi tiết : <span>${u.fullName}</span></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                          </div>
                          <div class="modal-body">
                            <div class="row">
                              <div class="col-6"> <h5>Họ tên :</h5> <p>${u.fullName}</p>
                                <h5>Email:</h5> <p>${u.email}</p>
                                <h5>Số điện thoại:</h5> <p>${u.phoneNumber}</p>
                                <h5>Tài khoản:</h5> <p>${u.userName}</p></div>
                              <div class="col-6">   <h5>Địa chỉ :</h5> <p th:text="${user.address}" ></p>
                                <h5>Vai trò:</h5> <p>${u.role.roleName}</p>
                          ...
                          <div class="row">
                            ...
                            <div class="col-6">
                              ...
                              <input readonly type="email" class="form-control"
                                     id="addcost" name="email" value="${u.email }" required>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-6">
                              <label for="addname"
                                     class="col-form-label">Số điện thoại:</label>
                              <input type="number" class="form-control"
                                     id="addname" name="phoneNumber" value="${u.phoneNumber }" required>
                            </div>
                            <div class="col-6">
                              <label for="addcost"
                                     class="col-form-label">Địa chỉ:</label>
                              <input type="text" class="form-control"
                                     id="addcost" name="address" value="" required>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-6">
                              ...
                              <input readonly type="text" class="form-control"
                                     id="addname" name="userName" value="${u.userName }" required>
